...
/*!**************************!*\
  !*** ./src/FetchRail.js ***!
  \**************************/
/*! exports provided: FetchRail, dataJsonRail, algarveRail */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"FetchRail\", function() { return FetchRail; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"dataJsonRail\", function() { return dataJsonRail; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"algarveRail\", function() { return algarveRail; });\n/* harmony import */ var _RetailRailClass__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./RetailRailClass */ \"./src/RetailRailClass.js\");\n // HELPER FUNCTION - parse response data into JSON\n\nfunction FetchRail(url) {\n  return fetch(url).then(function (res) {\n    return res.json();\n  })[\"catch\"](function (err) {\n    return console.log('Something went wrong...', err);\n  });\n} // create new rail from data.json\n\nvar dataJsonRail = FetchRail('./data.json').then(function (res) {\n  return new _RetailRailClass__WEBPACK_IMPORTED_MODULE_0__[\"default\"]({\n    parentContainer: res[0].parentContainer,\n    title: res[0].testTitle[0].sh_title,\n    bodyText: res[0].bodyText,\n    ctaText: res[0].ctaText,\n    ctaHref: res[0].ctaHref\n  });\n}); // // create new rail from algarve acf \n\nvar algarveRail = FetchRail('https://www.conradalgarve.com/wp-json/acf/v3/pages/5').then(function (res) {\n  return new _RetailRailClass__WEBPACK_IMPORTED_MODULE_0__[\"default\"]({\n    parentContainer: res.parentContainer,\n    title: res.acf.new_split_panels[0].sh_title + ' - from algarve',\n    bodyText: res.acf.new_split_panels[0].sh_usp[0].description + ' - blah, blah, blah, blah, blah',\n    extraClasses: ['light-green']\n  });\n});\n\n//# sourceURL=webpack:///./src/FetchRail.js?");
...
/*!*************************!*\
  !*** ./src/RailAjax.js ***!
  \*************************/
/*! exports provided: railajax */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"railajax\", function() { return railajax; });\n/* harmony import */ var _RetailRailClass__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./RetailRailClass */ \"./src/RetailRailClass.js\");\n // AJAX\n\nfunction FetchACFRetailRail(props) {\n  var xhr = new XMLHttpRequest();\n\n  xhr.onreadystatechange = function () {\n    if (xhr.readyState === 4) {\n      if (xhr.status === 200) {\n        var content = JSON.parse(xhr.responseText);\n        new _RetailRailClass__WEBPACK_IMPORTED_MODULE_0__[\"default\"]({\n          parentContainer: content[0].parentContainer,\n          title: content[0].title,\n          bodyText: content[0].bodyText,\n          ctaText: content[0].ctaText,\n          ctaHref: content[0].ctaHref,\n          extraClasses: content[0].extraClasses\n        });\n      } else {\n        alert(xhr.statusText);\n      }\n    }\n  };\n\n  xhr.open('GET', props.endPoint);\n  xhr.send();\n}\n\nvar railajax = FetchACFRetailRail({\n  endPoint: 'ajax.json'\n});\n\n//# sourceURL=webpack:///./src/RailAjax.js?");
...
/*!**************************!*\
  !*** ./src/RailAsync.js ***!
  \**************************/
/*! exports provided: AsyncFetchRail, asyncRail */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"AsyncFetchRail\", function() { return AsyncFetchRail; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"asyncRail\", function() { return asyncRail; });\n/* harmony import */ var _RetailRailClass__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./RetailRailClass */ \"./src/RetailRailClass.js\");\nfunction asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }\n\nfunction _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"next\", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"throw\", err); } _next(undefined); }); }; }\n\n // ASYNC / AWAIT \n\nfunction AsyncFetchRail(_x) {\n  return _AsyncFetchRail.apply(this, arguments);\n}\n\nfunction _AsyncFetchRail() {\n  _AsyncFetchRail = _asyncToGenerator(\n  /*#__PURE__*/\n  regeneratorRuntime.mark(function _callee(url) {\n    var response, data;\n    return regeneratorRuntime.wrap(function _callee$(_context) {\n      while (1) {\n        switch (_context.prev = _context.next) {\n          case 0:\n            _context.prev = 0;\n            _context.next = 3;\n            return fetch(url);\n\n          case 3:\n            response = _context.sent;\n            _context.next = 6;\n            return response.json();\n\n          case 6:\n            data = _context.sent;\n            return _context.abrupt(\"return\", data);\n\n          case 10:\n            _context.prev = 10;\n            _context.t0 = _context[\"catch\"](0);\n            console.log(new Error('Something went wrong with the AsyncFetchRail function call - check that the endpoint is valid', _context.t0));\n\n          case 13:\n          case \"end\":\n            return _context.stop();\n        }\n      }\n    }, _callee, null, [[0, 10]]);\n  }));\n  return _AsyncFetchRail.apply(this, arguments);\n}\n\nvar asyncRail = AsyncFetchRail('data.json');\nasyncRail.then(function (res) {\n  return new _RetailRailClass__WEBPACK_IMPORTED_MODULE_0__[\"default\"]({\n    parentContainer: res[0].parentContainer,\n    title: 'This rail was pulled from data.json, using async/await',\n    bodyText: res[0].bodyText,\n    ctaText: res[0].ctaText,\n    ctaHref: res[0].ctaHref,\n    extraClasses: ['pink']\n  });\n})[\"catch\"](function (err) {\n  printError(err, 'asyncRail');\n});\n\nfunction printError(err, funcName) {\n  console.log(new Error('Something went wrong with the ' + funcName + ' function call - check that all params are valid', err));\n}\n\n//# sourceURL=webpack:///./src/RailAsync.js?");

/***/ }),

/***/ "./src/RailCustomData.js":
/*!*******************************!*\
  !*** ./src/RailCustomData.js ***!
  \*******************************/
/*! no exports provided */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _FetchRail__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./FetchRail */ \"./src/FetchRail.js\");\n/* harmony import */ var _RailHardCoded__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./RailHardCoded */ \"./src/RailHardCoded.js\");\n/* harmony import */ var _RailCustomData__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./RailCustomData */ \"./src/RailCustomData.js\");\n/* harmony import */ var _RailAsync__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./RailAsync */ \"./src/RailAsync.js\");\n/* harmony import */ var _Publisher__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./Publisher */ \"./src/Publisher.js\");\n/* harmony import */ var _RailAjax__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./RailAjax */ \"./src/RailAjax.js\");\n\n\n\n\n\n\nvar railTimer = new _Publisher__WEBPACK_IMPORTED_MODULE_4__[\"Publisher\"]({\n  rail: _RailHardCoded__WEBPACK_IMPORTED_MODULE_1__[\"railTwo\"].getID(),\n  publish_offer: '20191226',\n  unpublish_offer: '20201227'\n});\n\n//# sourceURL=webpack:///./src/app.js?");
